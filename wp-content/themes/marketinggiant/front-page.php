...
<!-- Mirrored from html.crumina.net/html-seosight/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Jan 2019 17:28:16 GMT -->
<head lang="en">
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <title> marketinggiant.net </title>
    	wp-content/
    ...
    <!--External fonts-->
    <link href='../../fonts.googleapis.com/cssfa63.css?family=Varela+Round' rel='stylesheet' type='text/css'>
    ...
    <div class="container">
            <div class="top-bar-contact">
                <!-- <div class="contact-item">
                    <img src="img/united-states-of-america.png" class="flags" alt="flag">
                    <select>
                ...
                <div class="contact-item">
                    <i class="fas fa-phone"></i> 8 800 567.890.11
                </div>

                <div class="contact-item">
                    <a href="mailto:info@marketinggiant.net">info@marketinggiant.net</a>
                </div>
...
<header class="header" id="site-header">
    ...
    <div class="container">
            ...
            <div class="header-content-wrapper">
                ...
                <div class="logo">
                    <a href="#home" class="full-block-link"></a>
                    <img src="img/logo-eye.png" alt="Seosight">
                    <div class="logo-text">
                        <div class="logo-title">marketinggiant</div>
                        <div class="logo-sub-title">Digital Marketing</div>
                    </div>
                </div>
...
<div class="content-wrapper">
    <div class="header-spacer" id="home"></div>
<!-- Main Slider -->
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                        <div class="heading align-center">
                            <h4 class="h1 heading-title">What we do?</h4>
                            <div class="heading-line">
                                <span class="short-line"></span>
                                <span class="long-line"></span>
                            </div>
                            <p class="heading-text">
                                We manage your campaigns from creation to optimization to reporting. 
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="info-box--standard-centered">
                            ...
                            <div class="info-box-content">
                                <h4 class="info-box-title">Search</h4>
                                <p class="text">
                                    Extend your advertising campaign beyond traditional search networks to reach new customers efficiently. Experience incremental reach and stronger performance than the major search networks. We help you deliver the results.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="info-box--standard-centered">
                            ...
                            <div class="info-box-content">
                                <h4 class="info-box-title">Display & Video</h4>
                                <p class="text">
                                    Our publisher network and mobile apps allows us to custom-tailor your brand’s exposure to fit the needs of your campaign. Our platform enables video pre-roll, 3rd party tags, custom & rich media display units, and the hosting of multiple formats.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="info-box--standard-centered">
                            ...
                            <div class="info-box-content">
                                <h4 class="info-box-title">Native</h4>
                                <p class="text">Discover the right audience at the right time. We help you drive highly engaged audience to your site. Contact us to learn more about native advertising.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="heading">
                            ...
                            <p class="heading-text c-white">Marketing Giant is the largest search marketplace outside the major search networks, leveraging first-party data to drive performance.
                            </p>
                        </div>
            ...
            <div class="row">
                <div class="submit-block table">
                    <div class="col-lg-3 table-cell">
                        <button class="btn btn-small btn--primary" name="SubmitNow">
                ...
                <div class="subscribe scrollme">
                    ...
                    <div class="col-lg-6 col-lg-offset-5 col-md-6 col-md-offset-5 col-sm-12 col-xs-12">
                        ...
                        <form class="subscribe-form" method="post" action="">
                            ...
                            <button class="subscr-btn" name="subscr_btn">subscribe
            ...
            <div class="contacts">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="mailto:info@marketinggiant.net" class="title">info@marketinggiant.net</a>
    ...
    <div class="sub-footer">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <span>
                        Copyright © 2019 <a href="index-2.html" class="sub-footer__link">marketinggiant.net</a>
                        Designed by <a href="https://themeforest.net/user/themefire/portfolio">marketinggiant.net</a>
                    </span>
...
<!-- Mirrored from html.crumina.net/html-seosight/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Jan 2019 17:31:24 GMT -->
</html>
